...
function check() {
	...
	if(questionTurn == "player1"){
		...
		document.getElementById("playerQuestion").innerHTML ="turno de Pergunta:" +
		player2Name
	}
	else{
	questionTurn = "player1" 
	...
	if(answerTurn == "player1"){
		answerTurn = "player2" 
		document.getElementById("playerAnswer").innerHTML ="turno de Resposta:" +
		player2Name
	}
	else{
		answerTurn = "player1" 
